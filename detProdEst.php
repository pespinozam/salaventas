...
if($enlace_actual == 'http://localhost/salaventas/detProdEst.php'){
    $llave = false;
}else{
                    ...
                    <div class="row">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <h4>N° Estacionamiento:    <span id="uBod"></span> </h4>
                                    ...
                                    <div class="d-grid gap-2 col-6 mx-auto ">
                                        ...
                                        <?php 
                                            if($llave == true){
                                                ...
                                                echo '<a href="http://localhost/salaventas/misproductos.php" type="button" id="btnMinimizar" style = "background-color: rgb(255 151 53); color: white;" data-card-widget="collapse" class="btn p-1 m-1" style="">';
                                            }
                                        ?>
