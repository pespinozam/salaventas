...
foreach ($decoded_json as $rkey => $resource){
 ...
 $link_logo = "../assets/wood-logo.png";
?>
<!DOCTYPE html>
<html>
<head>
...
$llave = false;
if($enlace_actual == 'http://localhost/salaventas/proyectos/131wood.php'){
    $llave = false;
}else{
    $llave = true;
}?>

<span style="display: none;" id="proyecto">131WOOD</span>
...
<div class="col-12 col-md-12">
    <h1 class="d-flex justify-content-center mb-5"><b>¡Bienvenido a la nueva experiencia!</b></strong></h1>
</div>
</div>
<div class="row">
    <div class="col-12 col-md-12">
    ...
    <div id="collapseA2" class="collapse" data-bs-parent="#accordion">
      <div class="card-body">
       ...
       <?php 
            ...
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "A2"){
                    echo "<img id='url_imgA2' class='img-fluid' width='100%' src='".$resource["productos_url_planta"]."'></img>";
                    break;
                }
            }?>
            </div>
    ...
    <div id="collapseA3" class="collapse" data-bs-parent="#accordion">
      <div class="card-body">
       ...
       <?php 
            ...
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "A3"){
                    echo "<img id='url_imgA3' class='img-fluid' width='100%' src='".$resource["productos_url_planta"]."'></img>";
                    break;
                }
            }?>
            </div>
       ...
       <?php 
            ...
            <div class="col-md-6">
                <div id="divSelectBodB1" class="d-none">  
                    <label for="bodega">Bodega: </label>
                    <select data-bs-toggle="tooltip" title="Bodegas disponibles en el proyecto seleccionado." id="bodegaB1" class="form-select selectBod selectcito" name="nombre_proyecto">
                        <option  value="0">Seleccione Bodega<option>
                    <?php
                            foreach(array_unique($bodegas) as $val) {
                                echo "<option value='".$val."'>".$val."</option>";
...
return new bootstrap.Tooltip(tooltipTriggerEl)
        ...
        //     $("#porcentaje").text($(".rango").val());
        //     var uf = $("#cotizador-credito-valor-uf").val();
        //     var total = uf * $('.rango').val()/100;
        //     $(".valor-prop-uf").text(total);
        //     var resultado = uf_d * total;
        //     var formattedResultado = new Intl.NumberFormat('es-CL', { style: 'currency', currency: 'CLP' }).format(resultado);
        //     $(".valor-prop-clp").text(formattedResultado);
        // });
        ...
        $( "#check_varsB3" ).click(function() {
            ...
            console.log(total_propiedad_uf.toFixed(2));
