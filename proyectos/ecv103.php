...
$departamentosD6 = array();
$departamentosD4 = array();
$departamentosD3 = array();
$departamentosC3 = array();
$departamentosB = array();
$departamentosD8 = array();
...
$link_logo = "../assets/ecv103-logo.png";
?>
<!DOCTYPE html>
<html>
<head>
...
$llave = false;
if($enlace_actual == 'http://localhost/salaventas/proyectos/ecv103.php'){
    $llave = false;
}else{
    $llave = true;
}?>

<span style="display: none;" id="proyecto">ECV103</span>
    ...
    <div id="collapseC3" class="collapse" data-bs-parent="#accordion">
      <div class="card-body">
       ...
       <?php 
            ...
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "C3"){
                    echo "<img id='url_imgC3'  class='img-fluid' width='100%' src='".$resource["productos_url_planta"]."'></img>";
                    break;
                }
            }?>
            </div>
            ...
            <div class="col-md-6 mb-2">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input classRadioBod" type="radio" onchange="despliegaBodega('C3');" name="radioBodegaC3" id="bodRadio1" value="1">
                    <label class="form-check-label" for="inlineRadio1">Sí</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input classRadioBod" type="radio" onchange="despliegaBodega('C3');" name="radioBodegaC3" id="bodRadio2" value="0" checked>
                    <label class="form-check-label" for="inlineRadio2">No</label>
                </div>
            </div>
            <div class="col-md-6">
...
<div class="card">
    <div class="card-header">
      <a class="btn" data-bs-toggle="collapse" href="#collapseD8">
      <b class="card-title">Tipología D8 </b>
      </a>
    </div>
    <div id="collapseD8" class="collapse" data-bs-parent="#accordion">
      <div class="card-body">
       <div id="select">
       <?php 
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "D8"){
                    $departamentosD8[] = $resource["productos_id"]." | ".$resource["productos_nombre"]." | ".$resource["productos_tipo"]." | ".$resource["productos_cantidad_dormitorios"]."D + ".$resource["productos_cantidad_banios"]."B | UF ".$resource["productos_precio_lista"]." | ".$resource["productos_orientacion"]." | ".$resource["productos_superficie_comercial"];
                }
        }?>
            ...
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "D8"){
                    echo "<img id='url_imgD8' class='img-fluid' width='100%' src='".$resource["productos_url_planta"]."'></img>";
                    break;
                }
            }?>
            </div>
            <div class="col-md-6">
            <label for="departamento">Departamentos:  </label>
            <select data-bs-toggle="tooltip" title="Departamentos disponibles en el proyecto seleccionado." id="departamentoD8" class="form-select selectcito departamento" name="nombre_proyecto">
                <option value="0">Seleccione Departamento<option>
            <?php
                    foreach(array_unique($departamentosD8) as $val) {
                        echo "<option value='".$val."'>".$val."</option>";
            }?>
            </select>
            </div>
            ...
            <div class="col-md-6 mb-2">
                <label for="estacionamiento">¿Deseas Estacionamiento?</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" onchange="despliegaEstacionamiento('D8');" name="radioEstacionamientoD8" id="estaRadio1" value="1">
                    <label class="form-check-label" for="inlineRadio1">Sí</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" onchange="despliegaEstacionamiento('D8');" name="radioEstacionamientoD8" id="estaRadio2" value="0" checked>
                    <label class="form-check-label" for="inlineRadio2">No</label>
                </div>
            </div>
            <div class="col-md-6">
                <div id="divSelectEstD8" class="d-none">   
                    <label for="estacionamiento">Estacionamiento:  </label>
                    <select data-bs-toggle="tooltip" title="Estacionamientos disponibles en el proyecto seleccionado." id="estacionamientoD8" class="form-select selectcito" name="nombre_proyecto">
                        <option value="0">Seleccione Estacionamiento<option>
                    <?php
                            foreach(array_unique($estacionamientos) as $val) {
                                echo "<option value='".$val."'>".$val."</option>";
            ...
            <div class="col-md-6 mb-2">
                <label for="estacionamiento">¿Deseas Bodega?</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input classRadioBod" type="radio" onchange="despliegaBodega('D8');" name="radioBodegaD8" id="bodRadio1" value="1">
                    <label class="form-check-label" for="inlineRadio1">Sí</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input classRadioBod" type="radio" onchange="despliegaBodega('D8');" name="radioBodegaD8" id="bodRadio2" value="0" checked>
                    <label class="form-check-label" for="inlineRadio2">No</label>
                </div>
            </div>
            <div class="col-md-6">
                <div id="divSelectBodD8" class="d-none">  
                    <label for="bodega">Bodega: </label>
                    <select data-bs-toggle="tooltip" title="Bodegas disponibles en el proyecto seleccionado." id="bodegaD8" class="form-select selectcito" name="nombre_proyecto">
                        <option  value="0">Seleccione Bodega<option>
                    <?php
                            foreach(array_unique($bodegas) as $val) {
                                echo "<option value='".$val."'>".$val."</option>";
            ...
            <div class="col-md-6">
                    <label for="nombre">Nombre y Apellido: </label>
                    <input value="<?php echo isset($session_data[0]['nombre_cliente']) ? ucwords($session_data[0]['nombre_cliente']) : '';?>" maxlength="100" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122)) || (event.charCode == 32) || (event.charCode == 209) || (event.charCode == 241)" data-bs-toggle="tooltip" title="Por favor escribe tu nombre completo." id="nombre_completoD8" class="form-control nombreCotizante" name="nombre_proyecto">
                </div>
                <div class="col-md-6">
                    <label for="rut">RUT: </label>
                    <input maxlength="12" value="<?php echo isset($session_data[0]['rut_cliente']) ? ($session_data[0]['rut_cliente']) : '';?>" data-bs-toggle="tooltip" title="Por favor escribe tu Rut" id="rutD8" class="form-control rut" name="nombre_proyecto">
                </div>
                </div>
                <br>
            <div class="row">
                <div class="col-md-4">
                    <label for="email">E-mail: </label>
                    <input maxlength="100" value="<?php echo isset($session_data[0]['email']) ? ($session_data[0]['email']) : '';?>" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode == 64) || (event.charCode == 45) || (event.charCode == 95) || (event.charCode >= 46) || (event.charCode >= 241))" data-bs-toggle="tooltip" title="Por favor escribe tu E-mail, por este medio nos contactaremos contigo." id="emailD8" class="form-control emailCotizante" name="nombre_proyecto">
                </div>

                <div class="col-md-4">
                    <label for="email">Teléfono: </label>
                    <input maxlength="12" value="<?php echo isset($session_data[0]['telefono1']) ? ($session_data[0]['telefono1']) : '';?>" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 43))" data-bs-toggle="tooltip" title="Por favor escribe tu teléfono, por este medio nos contactaremos contigo." id="telefonoD8" class="form-control telefonoCotizante" name="nombre_proyecto" value="+569">
                </div>

                <div class="col-md-4">
                <label for="inv-vi">¿Invertir o Vivir? </label>
                <select data-bs-toggle="tooltip" title="Desear vivir o invertir con nuestros productos." id="invertir_vivirD8" class="form-select selectcito" name="nombre_proyecto">
                    <option  value="1">Vivir</option>
                    <option  value="2">Invertir</option>
                </select>
                </div>
                ...
                <div class="row">
                    <div class="v-center d-grid gap-1 col-6 mx-auto">
                        <a href="#contenido" id="check_varsD8" class="btn btn-dark check_vars">Cotizar</a>
                    </div>
                </div>
                <!-- <a href="#contenido" id="check_varsD8" class="btn btn-light check_vars">Cotizar</a> -->
                <br>
       </div>
      </div>
    </div>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      ...
      <div class="card">
    <div class="card-header">
      <a class="btn" data-bs-toggle="collapse" href="#collapseD4">
      <b class="card-title">Tipología D4 </b>
      </a>
    </div>
    <div id="collapseD4" class="collapse" data-bs-parent="#accordion">
      <div class="card-body">
       <div id="select">
       <?php 
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "D4"){
                    $departamentosD4[] = $resource["productos_id"]." | ".$resource["productos_nombre"]." | ".$resource["productos_tipo"]." | ".$resource["productos_cantidad_dormitorios"]."D + ".$resource["productos_cantidad_banios"]."B | UF ".$resource["productos_precio_lista"]." | ".$resource["productos_orientacion"]." | ".$resource["productos_superficie_comercial"];
                }
        }?>
            ...
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "D4"){
                    echo "<img  id='url_imgD4' width='100%' class='img-fluid' src='".$resource["productos_url_planta"]."'></img>";
                    break;
                }
            }?>
            </div>
            <div class="col-md-6">
            <label for="departamento">Departamentos:  </label>
            <select data-bs-toggle="tooltip" title="Departamentos disponibles en el proyecto seleccionado." id="departamentoD4" class="form-select selectcito departamento" name="nombre_proyecto">
                <option value="0">Seleccione Departamento<option>
            <?php
                    foreach(array_unique($departamentosD4) as $val) {
                        echo "<option value='".$val."'>".$val."</option>";
            }?>
            </select>
            </div>
            ...
            <div class="col-md-6 mb-2">
                <label for="estacionamiento">¿Deseas Estacionamiento?</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" onchange="despliegaEstacionamiento('D4');" name="radioEstacionamientoD4" id="estaRadio1" value="1">
                    <label class="form-check-label" for="inlineRadio1">Sí</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" onchange="despliegaEstacionamiento('D4');" name="radioEstacionamientoD4" id="estaRadio2" value="0" checked>
                    <label class="form-check-label" for="inlineRadio2">No</label>
                </div>
            </div>
            <div class="col-md-6">
                <div id="divSelectEstD4" class="d-none">   
                    <label for="estacionamiento">Estacionamiento:  </label>
                    <select data-bs-toggle="tooltip" title="Estacionamientos disponibles en el proyecto seleccionado." id="estacionamientoD4" class="form-select selectcito" name="nombre_proyecto">
                        <option value="0">Seleccione Estacionamiento<option>
                    <?php
                            foreach(array_unique($estacionamientos) as $val) {
                                echo "<option value='".$val."'>".$val."</option>";
            ...
            <div class="col-md-6 mb-2">
                <label for="estacionamiento">¿Deseas Bodega?</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input classRadioBod" type="radio" onchange="despliegaBodega('D4');" name="radioBodegaD4" id="bodRadio1" value="1">
                    <label class="form-check-label" for="inlineRadio1">Sí</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input classRadioBod" type="radio" onchange="despliegaBodega('D4');" name="radioBodegaD4" id="bodRadio2" value="0" checked>
                    <label class="form-check-label" for="inlineRadio2">No</label>
                </div>
            </div>
            <div class="col-md-6">
                <div id="divSelectBodD4" class="d-none">  
                    <label for="bodega">Bodega: </label>
                    <select data-bs-toggle="tooltip" title="Bodegas disponibles en el proyecto seleccionado." id="bodegaD4" class="form-select selectcito" name="nombre_proyecto">
                        <option  value="0">Seleccione Bodega<option>
                    <?php
                            foreach(array_unique($bodegas) as $val) {
                                echo "<option value='".$val."'>".$val."</option>";
            ...
            <div class="col-md-6">
                    <label for="nombre">Nombre y Apellido: </label>
                    <input value="<?php echo isset($session_data[0]['nombre_cliente']) ? ucwords($session_data[0]['nombre_cliente']) : '';?>" maxlength="100" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122)) || (event.charCode == 32) || (event.charCode == 209) || (event.charCode == 241)" data-bs-toggle="tooltip" title="Por favor escribe tu nombre completo." id="nombre_completoD4" class="form-control nombreCotizante" name="nombre_proyecto">
                </div>
                <div class="col-md-6">
                    <label for="rut">RUT: </label>
                    <input maxlength="12" value="<?php echo isset($session_data[0]['rut_cliente']) ? ($session_data[0]['rut_cliente']) : '';?>" data-bs-toggle="tooltip" title="Por favor escribe tu Rut" id="rutD4" class="form-control rut" name="nombre_proyecto">
                </div>
                </div>
                <br>
            <div class="row">
                <div class="col-md-4">
                    <label for="email">E-mail: </label>
                    <input maxlength="100" value="<?php echo isset($session_data[0]['email']) ? ($session_data[0]['email']) : '';?>" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode == 64) || (event.charCode == 45) || (event.charCode == 95) || (event.charCode >= 46) || (event.charCode >= 241))" data-bs-toggle="tooltip" title="Por favor escribe tu E-mail, por este medio nos contactaremos contigo." id="emailD4" class="form-control emailCotizante" name="nombre_proyecto">
                </div>

                <div class="col-md-4">
                    <label for="email">Teléfono: </label>
                    <input maxlength="12" value="<?php echo isset($session_data[0]['telefono1']) ? ($session_data[0]['telefono1']) : '';?>" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 43))" data-bs-toggle="tooltip" title="Por favor escribe tu teléfono, por este medio nos contactaremos contigo." id="telefonoD4" class="form-control telefonoCotizante" name="nombre_proyecto" value="+569">
                </div>

                <div class="col-md-4">
                <label for="inv-vi">¿Invertir o Vivir? </label>
                <select data-bs-toggle="tooltip" title="Desear vivir o invertir con nuestros productos." id="invertir_vivirD4" class="form-select selectcito" name="nombre_proyecto">
                    <option  value="1">Vivir</option>
                    <option  value="2">Invertir</option>
                </select>
                </div>
                ...
                <div class="row">
                    <div class="v-center d-grid gap-1 col-6 mx-auto">
                        <a href="#contenido" id="check_varsD4" class="btn btn-dark check_vars">Cotizar</a>
                    </div>
                </div>
                <!-- <a href="#contenido" id="check_varsD4" class="btn btn-light check_vars">Cotizar</a> -->
                <br>
       </div>
      </div>
    </div>
    ...
    <div id="collapseB" class="collapse" data-bs-parent="#accordion">
      <div class="card-body">
       ...
       <?php 
            ...
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "B"){
                    echo "<img   id='url_imgB' width='100%' class='img-fluid' src='".$resource["productos_url_planta"]."'></img>";
                    break;
                }
            }?>
            </div>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
      ...
      <div class="card">
    <div class="card-header">
      <a class="btn" data-bs-toggle="collapse" href="#collapseD6">  
      <b class="card-title">Tipología D6 </b>
      </a>
    </div>
    <div id="collapseD6" class="collapse" data-bs-parent="#accordion">
      <div class="card-body">
       
      <div id="select">
        <?php 
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "D6"){
                    $departamentosD6[] = $resource["productos_id"]." | ".$resource["productos_nombre"]." | ".$resource["productos_tipo"]." | ".$resource["productos_cantidad_dormitorios"]."D + ".$resource["productos_cantidad_banios"]."B | UF ".$resource["productos_precio_lista"]." | ".$resource["productos_orientacion"]." | ".$resource["productos_superficie_comercial"];
                }
        }?>
            ...
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "D6"){
                    echo "<img  id='url_imgD6' width='100%' class='img-fluid' src='".$resource["productos_url_planta"]."'></img>";
                    break;
                }
            }?>
            </div>
            <div class="col-md-6">
            <label for="departamento">Departamentos:  </label>
            <select data-bs-toggle="tooltip" title="Departamentos disponibles en el proyecto seleccionado."  id="departamentoD6" class="form-select selectcito" name="nombre_proyecto">
                <option value="0">Seleccione Departamento<option>
            <?php
                    foreach(array_unique($departamentosD6) as $val) {
                        echo "<option value='".$val."'>".$val."</option>";
            }?>
            </select>
            </div>
            ...
            <div class="col-md-6 mb-2">
                <label for="estacionamiento">¿Deseas Estacionamiento?</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" onchange="despliegaEstacionamiento('D6');" name="radioEstacionamientoD6" id="estaRadio1" value="1">
                    <label class="form-check-label" for="inlineRadio1">Sí</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" onchange="despliegaEstacionamiento('D6');" name="radioEstacionamientoD6" id="estaRadio2" value="0" checked>
                    <label class="form-check-label" for="inlineRadio2">No</label>
                </div>
            </div>
            <div class="col-md-6">
                <div id="divSelectEstD6" class="d-none">   
                    <label for="estacionamiento">Estacionamiento:  </label>
                    <select data-bs-toggle="tooltip" title="Estacionamientos disponibles en el proyecto seleccionado." id="estacionamientoD6" class="form-select selectcito" name="nombre_proyecto">
                        <option value="0">Seleccione Estacionamiento<option>
                    <?php
                            foreach(array_unique($estacionamientos) as $val) {
                                echo "<option value='".$val."'>".$val."</option>";
            ...
            <div class="col-md-6 mb-2">
                <label for="estacionamiento">¿Deseas Bodega?</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input classRadioBod" type="radio" onchange="despliegaBodega('D6');" name="radioBodegaD6" id="bodRadio1" value="1">
                    <label class="form-check-label" for="inlineRadio1">Sí</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input classRadioBod" type="radio" onchange="despliegaBodega('D6');" name="radioBodegaD6" id="bodRadio2" value="0" checked>
                    <label class="form-check-label" for="inlineRadio2">No</label>
                </div>
            </div>
            <div class="col-md-6">
                <div id="divSelectBodD6" class="d-none">  
                    <label for="bodega">Bodega: </label>
                    <select data-bs-toggle="tooltip" title="Bodegas disponibles en el proyecto seleccionado." id="bodegaD6" class="form-select selectcito" name="nombre_proyecto">
                        <option  value="0">Seleccione Bodega<option>
                    <?php
                            foreach(array_unique($bodegas) as $val) {
                                echo "<option value='".$val."'>".$val."</option>";
            ...
            <div class="col-md-6">
                    <label for="nombre">Nombre y Apellido: </label>
                    <input value="<?php echo isset($session_data[0]['nombre_cliente']) ? ucwords($session_data[0]['nombre_cliente']) : '';?>" maxlength="100" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122)) || (event.charCode == 32) || (event.charCode == 209) || (event.charCode == 241)" data-bs-toggle="tooltip" title="Por favor escribe tu nombre completo." id="nombre_completoD6" class="form-control nombreCotizante" name="nombre_proyecto">
                </div>
                <div class="col-md-6">
                    <label for="rut">RUT: </label>
                    <input maxlength="12" value="<?php echo isset($session_data[0]['rut_cliente']) ? ($session_data[0]['rut_cliente']) : '';?>" data-bs-toggle="tooltip" title="Por favor escribe tu Rut" id="rutD6" class="form-control rut" name="nombre_proyecto">
                </div>
                </div>
                <br>
            <div class="row">
                <div class="col-md-4">
                    <label for="email">E-mail: </label>
                    <input maxlength="100" value="<?php echo isset($session_data[0]['email']) ? ($session_data[0]['email']) : '';?>" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode == 64) || (event.charCode == 45) || (event.charCode == 95) || (event.charCode >= 46) || (event.charCode >= 241))" data-bs-toggle="tooltip" title="Por favor escribe tu E-mail, por este medio nos contactaremos contigo." id="emailD6" class="form-control emailCotizante " name="nombre_proyecto">
                </div>

                <div class="col-md-4">
                    <label for="email">Teléfono: </label>
                    <input maxlength="12" value="<?php echo isset($session_data[0]['telefono1']) ? ($session_data[0]['telefono1']) : '';?>" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 43))" data-bs-toggle="tooltip" title="Por favor escribe tu teléfono, por este medio nos contactaremos contigo." id="telefonoD6" class="form-control telefonoCotizante" name="nombre_proyecto" value="+569">
                </div>

                <div class="col-md-4">
                <label for="inv-vi">¿Invertir o Vivir? </label>
                <select data-bs-toggle="tooltip" title="Desear vivir o invertir con nuestros productos." id="invertir_vivirD6" class="form-select selectcito" name="nombre_proyecto">
                    <option  value="1">Vivir</option>
                    <option  value="2">Invertir</option>
                </select>
                </div>
                ...
                <div class="row">
                    <div class="v-center d-grid gap-1 col-6 mx-auto">
                        <a href="#contenido" id="check_varsD6" class="btn btn-dark check_vars">Cotizar</a>
                    </div>
                </div>
                <!-- <a href="#contenido" id="check_varsD6" class="btn btn-light check_vars">Cotizar</a> -->
                <br>
            </div>
        </div>
    </div>
...
<div class="card">
    <div class="card-header">
      <a class="btn" data-bs-toggle="collapse" href="#collapseD3">
      <b class="card-title">Tipología D3 </b>
      </a>
    </div>
    <div id="collapseD3" class="collapse" data-bs-parent="#accordion">
      <div class="card-body">
       <div id="select">
       <?php 
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "D3"){
                    $departamentosD3[] = $resource["productos_id"]." | ".$resource["productos_nombre"]." | ".$resource["productos_tipo"]." | ".$resource["productos_cantidad_dormitorios"]."D + ".$resource["productos_cantidad_banios"]."B | UF ".$resource["productos_precio_lista"]." | ".$resource["productos_orientacion"]." | ".$resource["productos_superficie_comercial"];
                }
        }?>
            ...
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "D3"){
                    echo "<img  id='url_imgD3'width='100%' class='img-fluid' src='".$resource["productos_url_planta"]."'></img>";
                    break;
                }
            }?>
            </div>
            <div class="col-md-6">
            <label for="departamento">Departamentos:  </label>
            <select data-bs-toggle="tooltip" title="Departamentos disponibles en el proyecto seleccionado." id="departamentoD3" class="form-select selectcito departamento" name="nombre_proyecto">
                <option value="0">Seleccione Departamento<option>
            <?php
                    foreach(array_unique($departamentosD3) as $val) {
                        echo "<option value='".$val."'>".$val."</option>";
            }?>
            </select>
            </div>
            ...
            <div class="col-md-6 mb-2">
                <label for="estacionamiento">¿Deseas Estacionamiento?</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" onchange="despliegaEstacionamiento('D3');" name="radioEstacionamientoD3" id="estaRadio1" value="1">
                    <label class="form-check-label" for="inlineRadio1">Sí</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" onchange="despliegaEstacionamiento('D3');" name="radioEstacionamientoD3" id="estaRadio2" value="0" checked>
                    <label class="form-check-label" for="inlineRadio2">No</label>
                </div>
            </div>
            <div class="col-md-6">
                <div id="divSelectEstD3" class="d-none">   
                    <label for="estacionamiento">Estacionamiento:  </label>
                    <select data-bs-toggle="tooltip" title="Estacionamientos disponibles en el proyecto seleccionado." id="estacionamientoD3" class="form-select selectcito" name="nombre_proyecto">
                        <option value="0">Seleccione Estacionamiento<option>
                    <?php
                            foreach(array_unique($estacionamientos) as $val) {
                                echo "<option value='".$val."'>".$val."</option>";
            ...
            <div class="col-md-6 mb-2">
                <label for="estacionamiento">¿Deseas Bodega?</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input classRadioBod" type="radio" onchange="despliegaBodega('D3');" name="radioBodegaD3" id="bodRadio1" value="1">
                    <label class="form-check-label" for="inlineRadio1">Sí</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input classRadioBod" type="radio" onchange="despliegaBodega('D3');" name="radioBodegaD3" id="bodRadio2" value="0" checked>
                    <label class="form-check-label" for="inlineRadio2">No</label>
                </div>
            </div>
            <div class="col-md-6">
                <div id="divSelectBodD3" class="d-none">  
                    <label for="bodega">Bodega: </label>
                    <select data-bs-toggle="tooltip" title="Bodegas disponibles en el proyecto seleccionado." id="bodegaD3" class="form-select selectcito" name="nombre_proyecto">
                        <option  value="0">Seleccione Bodega<option>
                    <?php
                            foreach(array_unique($bodegas) as $val) {
                                echo "<option value='".$val."'>".$val."</option>";
            ...
            <div class="col-md-6">
                    <label for="nombre">Nombre y Apellido: </label>
                    <input value="<?php echo isset($session_data[0]['nombre_cliente']) ? ucwords($session_data[0]['nombre_cliente']) : '';?>" maxlength="100" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122)) || (event.charCode == 32) || (event.charCode == 209) || (event.charCode == 241)" data-bs-toggle="tooltip" title="Por favor escribe tu nombre completo." id="nombre_completoD3" class="form-control nombreCotizante" name="nombre_proyecto">
                </div>
                <div class="col-md-6">
                    <label for="rut">RUT: </label>
                    <input maxlength="12" value="<?php echo isset($session_data[0]['rut_cliente']) ? ($session_data[0]['rut_cliente']) : '';?>" data-bs-toggle="tooltip" title="Por favor escribe tu Rut" id="rutD3" class="form-control rut" name="nombre_proyecto">
                </div>
                </div>
                <br>
            <div class="row">
                <div class="col-md-4">
                    <label for="email">E-mail: </label>
                    <input maxlength="100" value="<?php echo isset($session_data[0]['email']) ? ($session_data[0]['email']) : '';?>" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode == 64) || (event.charCode == 45) || (event.charCode == 95) || (event.charCode >= 46) || (event.charCode >= 241))" data-bs-toggle="tooltip" title="Por favor escribe tu E-mail, por este medio nos contactaremos contigo." id="emailD3" class="form-control emailCotizante" name="nombre_proyecto">
                </div>

                <div class="col-md-4">
                    <label for="email">Teléfono: </label>
                    <input maxlength="12" value="<?php echo isset($session_data[0]['telefono1']) ? ($session_data[0]['telefono1']) : '';?>" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 43))" data-bs-toggle="tooltip" title="Por favor escribe tu teléfono, por este medio nos contactaremos contigo." id="telefonoD3" class="form-control telefonoCotizante" name="nombre_proyecto" value="+569">
                </div>

                <div class="col-md-4">
                <label for="inv-vi">¿Invertir o Vivir? </label>
                <select data-bs-toggle="tooltip" title="Desear vivir o invertir con nuestros productos." id="invertir_vivirD3" class="form-select selectcito" name="nombre_proyecto">
                    <option  value="1">Vivir</option>
                    <option  value="2">Invertir</option>
                </select>
                </div>
                ...
                <div class="row">
                    <div class="v-center d-grid gap-1 col-6 mx-auto">
                        <a href="#contenido" id="check_varsD3" class="btn btn-dark check_vars">Cotizar</a>
                    </div>
                </div>
                <!-- <a href="#contenido" id="check_varsD3" class="btn btn-light check_vars">Cotizar</a> -->
                <br>
       </div>
      </div>
    </div>
    ...
    <div id="collapseA2" class="collapse" data-bs-parent="#accordion">
      <div class="card-body">
       ...
       <?php 
            ...
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "A2"){
                    echo "<img  id='url_imgA2' width='100%' class='img-fluid' src='".$resource["productos_url_planta"]."'></img>";
                    break;
                }
            }?>
            </div>
    ...
    <div id="collapseA3" class="collapse" data-bs-parent="#accordion">
      <div class="card-body">
       ...
       <?php 
            ...
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "A3"){
                    echo "<img  id='url_imgA3' width='100%' class='img-fluid' src='".$resource["productos_url_planta"]."'></img>";
                    break;
                }
            }?>
            </div>
    ...
    <div id="collapseA1" class="collapse" data-bs-parent="#accordion">
      <div class="card-body">
       ...
       <?php 
            ...
            foreach($decoded_json as $rkey => $resource) {
                    if($resource["productos_tipo_unidad"] == "Departamento" && $resource["productos_tipo"] == "A1"){
                    echo "<img  id='url_imgA1' width='100%' class='img-fluid' src='".$resource["productos_url_planta"]."'></img>";
                    break;
                }
            }?>
            </div>
            <div class="col-md-6">
            <label for="departamento">Departamentos:  </label>
            <select data-bs-toggle="tooltip" title="Departamentos disponibles en el proyecto seleccionado."  id="departamentoA1" class="form-select selectcito departamento" name="nombre_proyecto">
                <option value="0">Seleccione Departamento<option>
            <?php
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <label for="rut">RUT: </label>
                    <input maxlength="12" value="<?php echo isset($session_data[0]['rut_cliente']) ? ($session_data[0]['rut_cliente']) : '';?>" data-bs-toggle="tooltip" title="Por favor escribe tu Rut" id="rutA1" class="form-control rut" name="nombre_proyecto">
                </div>
                </div>
                <br>
            <div class="row">
...
function validacion_cotizar(depto, nombre_completo, rut, email, telefono, invertir_vivir, id){
    ...
    if (!(campos_vacios)) {
        ...
        console.log(bc_rut, bc_email, bc_telefono, bc_nombre_completo);
...
return new bootstrap.Tooltip(tooltipTriggerEl)
        ...
        if ($("#uf_dia_dt").text() == '') {
          ...
          $( "#check_varsD6" ).click(function() {
            
            var depto = $("#departamentoD6").val();
            var est = $("#estacionamientoD6").val();
            var bod = $("#bodegaD6").val();
            var nombre_completo = $("#nombre_completoD6").val();
            var rut = $("#rutD6").val();
            var email = $("#emailD6").val();
            var telefono = $("#telefonoD6").val();
            var invertir_vivir = $("#invertir_vivirD6").val();

            const validacionForm = validacion_cotizar(depto, nombre_completo, rut, email, telefono, invertir_vivir, 'D6');
            if (!(validacionForm)) {
                return false;
            }
            ...
            var url_imagen = $('#url_imgD6').attr('src');
        ...
        $( "#check_varsD4" ).click(function() {
            
            var depto = $("#departamentoD4").val();
            var est = $("#estacionamientoD4").val();
            var bod = $("#bodegaD4").val();
            var nombre_completo = $("#nombre_completoD4").val();
            var rut = $("#rutD4").val();
            var email = $("#emailD4").val();
            var telefono = $("#telefonoD4").val();
            var invertir_vivir = $("#invertir_vivirD4").val();

            const validacionForm = validacion_cotizar(depto, nombre_completo, rut, email, telefono, invertir_vivir, 'D4');
            if (!(validacionForm)) {
                return false;
            }
            var depto_values = depto.split("|");
            ...
            var url_imagen = $('#url_imgD4').attr('src');
        ...
        $( "#check_varsD3" ).click(function() {
            
            var depto = $("#departamentoD3").val();
            var est = $("#estacionamientoD3").val();
            var bod = $("#bodegaD3").val();
            var nombre_completo = $("#nombre_completoD3").val();
            var rut = $("#rutD3").val();
            var email = $("#emailD3").val();
            var telefono = $("#telefonoD3").val();
            var invertir_vivir = $("#invertir_vivirD3").val();

            const validacionForm = validacion_cotizar(depto, nombre_completo, rut, email, telefono, invertir_vivir, 'D3');
            if (!(validacionForm)) {
                return false;
            }
            var depto_values = depto.split("|");
            ...
            var url_imagen = $('#url_imgD3').attr('src');
        ...
        $( "#check_varsD8" ).click(function() {
            
            var depto = $("#departamentoD8").val();
            var est = $("#estacionamientoD8").val();
            var bod = $("#bodegaD8").val();
            var nombre_completo = $("#nombre_completoD8").val();
            var rut = $("#rutD8").val();
            var email = $("#emailD8").val();
            var telefono = $("#telefonoD8").val();
            var invertir_vivir = $("#invertir_vivirD8").val();
            const validacionForm = validacion_cotizar(depto, nombre_completo, rut, email, telefono, invertir_vivir, 'D8');
            if (!(validacionForm)) {
                return false;
            }
            var depto_values = depto.split("|");
            ...
            var url_imagen = $('#url_imgD8').attr('src');
