...
$link_logo = "../assets/talaveras-logo.png";
?>
<!DOCTYPE html>
<html>
<head>
<title>TALAVERAS72</title>
<meta charset="UTF-8">
...
<div class="accordion border border-4 border-dark" id="accordionExample">
  <div class="accordion-item">
    ...
    <div class="card-header">
      ...
      <b class="card-title">Tipología C1 </b> 
      </a>
    </div>
    <div id="collapseC1" 
...
return new bootstrap.Tooltip(tooltipTriggerEl)
        ...
        if ($("#uf_dia_dt").text() == '') {
          ...
          $( "#check_varsA1" ).click(function() {
            ...
            var total_propiedad_uf = parseFloat(values_depto[2]);
            ...
            var id_depto = depto_values[0];
            var id_est = est_values[0];
            var id_bod = bod_values[0];
