<?php 
    ...
    $sql = $db->connect()->prepare("SELECT b.id_producto, a.tipo_unidad, a.nombre, a.tipo, a.rol, b.proyecto, 
    a.superficie_comercial, a.cantidad_pisos, a.piso, a.orientacion, a.programa
